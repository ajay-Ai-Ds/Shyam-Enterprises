...
export async function generateMetadata({ params }: PageProps) {
  ...
  if (!project) {
    return {
      title: "Project Not Found | Shyam Enterprises",
    };
  }

  return {
    title: `${project.name} | Shyam Case Study`,
  ...
  return (
    <div className="bg-slate-50 min-h-screen py-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 flex flex-col gap-4">
            <h3 className="text-base font-bold text-slate-800 flex items-center gap-2">
              ...
              <span>Shyam Enterprises Solution</span>
            </h3>
            <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">
              {project.solution}
            </p>
        ...
        <div className="bg-primary-900 text-white rounded-3xl p-8 border border-primary-800 text-center flex flex-col items-center gap-3 mb-20 max-w-2xl mx-auto shadow-md">
          <h4 className="text-sm font-bold text-white uppercase tracking-wider">Project Verified Status</h4>
          <span className="text-xs font-extrabold text-accent-orange uppercase bg-white/10 border border-white/20 px-3 py-1 rounded-md">
            100% Quality Inspected &amp; Warranty Approved
          </span>
          <p className="text-xs text-slate-300 leading-relaxed">
            This installation passed all tension safety tests, anchor load checks, and high-rise structural compliance standards across Bangalore.
          </p>
        </div>
