...
export const metadata: Metadata = {
  title: "Photo Gallery | Shyam Enterprises - Safety Nets & Invisible Grills Bangalore",
  description: "Browse photos of balcony safety nets, bird proofing nets, invisible window grills, and ceiling cloth hangers installed by Shyam Enterprises in Bangalore.",
  alternates: {
    canonical: "/gallery",
  },
};
...
export default function GalleryPage() {
  ...
  const collectionSchema = {
    ...
    "@type": "CollectionPage",
    "name": "Photo Gallery | Shyam Enterprises",
    "url": "https://www.shyaminvisiblegrills.com/gallery",
    "description": "Photo archives of completed netting and invisible grill setups by Shyam in Bangalore.",
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left max-w-3xl mb-12 flex flex-col gap-3">
          ...
          <p className="text-slate-500 text-sm sm:text-base leading-relaxed">
            Browse through real photographs of Shyam Enterprises installations. Filters include Safety Netting types, Invisible Grills, Hangers, raw materials, and team operations.
          </p>
        </div>
