...
export const metadata: Metadata = {
  title: "About Us | Shyam Enterprises - Safety Nets & Invisible Grills Bangalore",
  description: "Learn about Shyam Enterprises, Bangalore's trusted safety netting and invisible grill installation specialists with 10+ years experience in child proofing and bird control.",
  alternates: {
    canonical: "/about",
  },
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left max-w-3xl mb-16 flex flex-col gap-3">
          ...
          <p className="text-slate-500 text-sm sm:text-base leading-relaxed">
            We are Bangalore&apos;s leading safety netting and invisible steel wire grill specialists, securing residential balconies, industrial duct shafts, and commercial spaces.
          </p>
        </div>
          ...
          <div className="lg:col-span-8 flex flex-col gap-8 text-left">
            <div className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200 shadow-xs flex flex-col gap-5">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Shyam Enterprises was established in Bangalore to address critical safety gaps in high-rise living. With the rapid development of residential townships along OMR, Velachery, and ECR, open balconies and low railings have become active hazards for children and household pets.
              </p>
              <p className="text-slate-500 text-sm leading-relaxed">
