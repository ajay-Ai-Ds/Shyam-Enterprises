...
export const metadata: Metadata = {
  title: "Safety & Childproofing Blog | Shyam Enterprises - Safety Nets & Invisible Grills Bangalore",
  description: "Read expert tips on balcony safety netting, invisible grill price guides, bird control solutions, and apartment childproofing from Shyam Enterprises Bangalore.",
  alternates: {
    canonical: "/blog",
  },
};
...
export default async function BlogPage() {
  ...
  const collectionSchema = {
    ...
    "@type": "CollectionPage",
    "name": "Safety and Home Childproofing Blog | Shyam",
    "url": "https://www.shyaminvisiblegrills.com/blog",
