...
export const metadata: Metadata = {
  title: "Search Services, Areas & Blogs | Shyam Enterprises",
  description:
    "Search across Shyam Enterprises balcony safety nets, invisible steel wire grills, laundry hangers, case study projects, and coverage areas in Bangalore.",
  alternates: {
    canonical: "/search",
  },
};
