...
export const metadata = {
  title: "Ceiling Cloth Hangers | Shyam Enterprises - Safety Nets & Invisible Grills Bangalore",
  description: "Rust-proof ceiling-mounted pulley cloth drying hangers installed in balconies and utility spaces by Shyam Enterprises Bangalore.",
  alternates: {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 3,
        "name": "Cloth Hangers",
        "item": "https://www.shyaminvisiblegrills.com/services/cloth-hangers",
      },
    ],
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left max-w-3xl mb-16 flex flex-col gap-3">
          ...
          <p className="text-slate-500 text-sm sm:text-base leading-relaxed">
            Optimize your balcony floor space using our space-saving cloth hangers. Choose from ceiling-mounted pulley hangers (smooth raising/lowering cords) or wall-mounted folding accordion grids. Heavy-duty, rustproof stainless steel pipes engineered for humid Bangalore weather.
          </p>
        </div>
