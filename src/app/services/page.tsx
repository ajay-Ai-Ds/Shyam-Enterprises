...
export const metadata = {
  title: "Our Services | Shyam Enterprises - Safety Nets & Invisible Grills Bangalore",
  description: "Explore Shyam Enterprises' comprehensive range of safety netting solutions, SS316 marine-grade invisible grills, and space-saving ceiling cloth drying hangers in Bangalore.",
  alternates: {
    canonical: "/services",
  },
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left max-w-3xl mb-16 flex flex-col gap-3">
          ...
          <p className="text-slate-500 text-sm sm:text-base leading-relaxed">
            Choose from our 18 certified safety netting, structural invisible grills, and drying hanger services in Bangalore. Handcrafted to protect your space cleanly.
          </p>
        </div>
