...
export const metadata = {
  title: "Invisible Grills | Shyam Enterprises - Safety Nets & Invisible Grills Bangalore",
  description: "Stainless steel 316 marine-grade invisible grills for balconies, windows, and staircases by Shyam Enterprises Bangalore. Unobstructed view with max security.",
  alternates: {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://www.shyaminvisiblegrills.com/services/invisible-grills",
      },
    ],
  };
