...
export async function fetchSiteSettings() {
  ...
  if (isMock) {
    return {
      businessName: "Shyam Enterprises",
      phone: "+91 95139 89222",
      email: "info.shyaminvisiblegrills@gmail.com",
      showNewsletter: true,
      socialLinks: {
        facebook: "https://facebook.com/shyamnets",
        instagram: "https://instagram.com/shyamnets",
        linkedin: "https://linkedin.com/company/shyamnets",
        youtube: "https://youtube.com/shyamnets",
      },
    };
  }
