...
function generateFAQsForService(serviceName: string, category: string): FAQItem[] {
  return [
    ...
    },
    {
      ...
      answer: "Yes, Shyam Enterprises offers a comprehensive 3 to 5 Year Manufacturer Warranty on safety nets and SS316 marine-grade invisible grills covering UV degradation and cable tension integrity.",
    },
    {
