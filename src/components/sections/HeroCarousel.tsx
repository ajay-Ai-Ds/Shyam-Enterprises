...
const slides: Slide[] = [
  ...
  },
  {
    ...
    subtitle: "Absolute safety for your children and pets without compromising ventilation. Customized high-tensile netting engineered to endure extreme Bangalore weather.",
