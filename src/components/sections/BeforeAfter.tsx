...
export default function BeforeAfter() {
  return (
    <section className="bg-[#FBF6F0] py-24 scroll-mt-12" id="gallery">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-3">
          <span className="text-xs font-bold uppercase tracking-widest text-accent-orange bg-white px-3.5 py-1.5 rounded-full inline-block self-center border border-slate-200">
            Before & After
          </span>
          ...
          >
            <div className="relative h-72 sm:h-96 w-full">
              <Image
                ...
                alt="Unprotected Bangalore apartment balcony before safety net installation"
                fill
          ...
          >
            <div className="relative h-72 sm:h-96 w-full">
              <Image
                ...
                alt="Bangalore apartment balcony after Shyam safety net installation"
                fill
                sizes="(max-width: 768px) 100vw, 50vw"
                className="object-cover"
              />
              <div className="absolute top-4 left-4 bg-accent-orange text-white text-xs font-bold uppercase px-3 py-1.5 rounded-md shadow-md flex items-center gap-1.5">
                <Sparkles className="w-3.5 h-3.5 fill-white/10" />
                <span>SHYAM ENTERPRISES PROTECTED</span>
              </div>
            </div>
            <div className="p-6">
              <h3 className="text-base font-bold text-slate-800 mb-2">After Shyam Professional Setup</h3>
              <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">
