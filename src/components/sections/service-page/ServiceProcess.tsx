...
// Why Choose Shyam Cards (6 cards)
export function ServiceWhyChoose() {
  ...
  return (
    <section className="bg-[#F7F5F0] py-20 scroll-mt-12" id="why-choose-shyam">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
// Related Services, Bangalore Areas, Blogs
...
export function ServiceRelated({ related, categoryName }: RelatedProps) {
  const areas = ["Adyar", "Velachery", "OMR Bangalore", "ECR Bangalore", "Tambaram"];

  const blogs = [
    { title: "Essential Balcony Safety Tips for Families living in High-Rise Apartments" },
    { title: "Why SS316 Marine Grade Invisible Grills are Best for Humid Bangalore Coastlines" },
                ...
                >
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-[10px] text-slate-500 font-medium">
                      Professional Installation Bangalore
                    </span>
                  </div>
