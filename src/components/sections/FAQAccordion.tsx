...
const faqs: FAQItem[] = [
  ...
  {
    id: 2,
    question: "Are your site inspection and measurements free of charge in Bangalore?",
    answer: "Yes, our technician site inspections, measurements, and catalog presentations are 100% free of charge across Bangalore, Karnataka. There are no hidden costs or commitments.",
  },
  {
    id: 3,
  ...
  {
    id: 4,
    question: "Can your safety nets withstand Bangalore sun and heavy rain?",
            ...
            return (
              <div
                ...
                className={`border rounded-2xl transition-all duration-300 ${
                  isOpen ? "border-accent-orange/40 bg-[#FBF6F0]/50 shadow-xs" : "border-slate-100 bg-white"
                }`}
              >
                {/* Question trigger */}
                <button
                ...
                >
                  ...
                  <span className="p-1.5 bg-slate-100 rounded-lg text-accent-orange shrink-0 ml-4 group">
                    {isOpen ? <Minus className="w-4 h-4 text-accent-orange" /> : <Plus className="w-4 h-4 text-accent-orange" />}
                  </span>
                </button>
